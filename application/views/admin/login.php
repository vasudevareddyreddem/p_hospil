...
<style>
    ...
    .backimg{
        background-image: url("<?php echo base_url(); ?>assets/vendor/img/loginbg1.jpg");
        ...
        <div class="form formLogin">
            ...
            <form id="loginform" name="loginform" action="<?php echo base_url('admin/loginpost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="email_id" name="email_id" placeholder="Email" value="<?php echo $this->input->cookie('username');?>" />
                </div>
                <div class="form-group">

    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Out source lab Support</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="<?php echo base_url('dashboard'); ?>">Dashboard</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">Out source lab Support</li>
                </ol>
            </div>
        </div>
        <!-- start widget -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 chat-help">
                                <div class="panel ">
                                    ...
                                    <form action="<?php echo base_url('chat/adminlabchatingpost'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="panel-footer"><br>
                                            <div class="input-group input-chat-des">

                                                <input type="hidden" name="replaying" id="replaying" value="" />
                                                <input type="hidden" name="labs_ids" id="labs_ids" value="<?php echo isset($chat_list[0]['user_id'])?$chat_list[0]['user_id']:'' ; ?>">

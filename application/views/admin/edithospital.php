   ...
   <div class="row">
      <div class="col-md-12 col-sm-12">
         ...
         <ul class="nav nav-tabs nav-justified x-scrool">
            <li class="nav-item">
               <a class="nav-link <?php if(isset($tab) && $tab==''){ echo "in show active"; }?>" data-toggle="tab" href="#Credentials" role="tab">Hospital Credentials</a>
            </li>
            <li class="nav-item">
         ...
         <div class="tab-content card">
            <!--Panel 1-->
            <div class="tab-pane fade  <?php if(isset($tab) && $tab==''){ echo "in show active"; }?>" id="Credentials" role="tabpanel">
               <br>
               <div class="card-body" id="bar-parent">
                  <form action="<?php echo base_url('hospital/editpost'); ?>" method="post" name="credentials" id="credentials" class="form-horizontal" enctype="multipart/form-data">
							<?php $csrf = array(
            ...
            <div class="tab-pane fade <?php if(isset($tab) && $tab==2){ echo "in show active"; }?>" id="Representative" role="tabpanel">
               <br>
               <div class="card-body" id="bar-parent">
                  <form action="<?php echo base_url('hospital/editpost'); ?>" method="post" name="representative" id="representative" class="form-horizontal" enctype="multipart/form-data">
                      	<?php $csrf = array(
										'name' => $this->security->get_csrf_token_name(),
										'hash' => $this->security->get_csrf_hash()
								); ?>
            ...
            <div class="tab-pane fade <?php if(isset($tab) && $tab==3){ echo "in show active"; }?>" id="BasicDetails" role="tabpanel">
               <br>
               <div class="card-body" id="bar-parent">
                  <form action="<?php echo base_url('hospital/editpost'); ?>" method="post" name="basicdetails" id="basicdetails" class="form-horizontal" enctype="multipart/form-data">
                     <?php $csrf = array(
										'name' => $this->security->get_csrf_token_name(),
										'hash' => $this->security->get_csrf_hash()
								); ?>
            ...
            <div class="tab-pane fade <?php if(isset($tab) && $tab==4){ echo "in show active"; }?>" id="HospitalFinancialDetails" role="tabpanel">
               <br>
               <div class="card-body" id="bar-parent">
                   <form action="<?php echo base_url('hospital/editpost'); ?>" method="post" name="financial" id="financial" class="form-horizontal" enctype="multipart/form-data">
                     <?php $csrf = array(
										'name' => $this->security->get_csrf_token_name(),
										'hash' => $this->security->get_csrf_hash()
								); ?>
            ...
            <div class="tab-pane fade <?php if(isset($tab) && $tab==5){ echo "in show active"; }?>" id="OtherDetails" role="tabpanel">
               <br>
               <div class="card-body" id="bar-parent">
                <form action="<?php echo base_url('hospital/editpost'); ?>" method="post" name="otherdetails" id="otherdetails" class="form-horizontal" enctype="multipart/form-data">
                     <?php $csrf = array(
										'name' => $this->security->get_csrf_token_name(),
										'hash' => $this->security->get_csrf_hash()
								); ?>
